...
class TestConvolution(unittest.TestCase):
    ...
    def test_kernel_3x3_easy(self):
        ...
        result_110 = convolve(matrix, kernel)
        answer_110 = np.array([[43, 43, 25, 17, 6], 
                               [52, 44, 17, 16, 6],
                               [30, 23, 10, 11, 6]])
        
        # stride = 1, dilation = 1, padding = 1
        result_111 = convolve(matrix, kernel, padding=(1, 1))
        ...
        result_120 = convolve(matrix, kernel, dilation=(2, 2))
        answer_120 = np.array([[11, 19, 3]])

        # stride = 1, dilation = 2, padding = 1
        result_121 = convolve(matrix, kernel, dilation=(2, 2), padding=(1, 1))
        answer_121 = np.array([[27, 15, 26,  6, 11],
                               [22, 11, 19,  3,  8],
                               [20,  8, 14,  0,  4]])
        
        # stride = 2, dilation = 1, padding = 0
        result_210 = convolve(matrix, kernel, stride=(2, 2))
        answer_210 = np.array([[43, 25, 6], 
                               [30, 10, 6]])
        
        # stride = 2, dilation = 1, padding = 1
        result_211 = convolve(matrix, kernel, stride=(2, 2), padding=(1, 1))
        answer_211 = np.array([[33, 24,  9,  3],
                               [45, 44, 16,  4],
                               [15, 12,  8,  1]])
        
        # stride = 2, dilation = 2, padding = 0
        result_220 = convolve(matrix, kernel, stride=(2, 2), dilation=(2, 2))
        answer_220 = np.array([[11, 3]])

        # stride = 2, dilation = 2, padding = 1
        result_221 = convolve(matrix, kernel, stride=(2, 2), dilation=(2, 2), padding=(1, 1))
    ...
    def test_kernel_5x5_difficult(self):
        ...
        # default params
        result_11_11_00 = convolve(matrix, kernel)
        ...
        result_12_11_00 = convolve(matrix, kernel, stride=(1, 2))
        ...
        result_13_11_00 = convolve(matrix, kernel, stride=(1, 3))
        ...
        result_21_11_00 = convolve(matrix, kernel, stride=(2, 1))
        answer_21_11_00 = np.array([[44., 58., 59., 62., 70., 80., 75., 92., 64., 72.],
                                    [66., 63., 60., 64., 76., 79., 75., 82., 77., 64.],
                                    [74., 71., 63., 66., 61., 75., 79., 47., 73., 76.]])

        result_22_11_00 = convolve(matrix, kernel, stride=(2, 2))
        answer_22_11_00 = np.array([[44., 59., 70., 75., 64],
                                    [66., 60., 76., 75., 77],
                                    [74., 63., 61., 79., 73]])

        result_23_11_00 = convolve(matrix, kernel, stride=(2, 3))
        answer_23_11_00 = np.array([[44., 62., 75., 72.],
                                    [66., 64., 75., 64.],
                                    [74., 66., 79., 76.]])

        result_31_11_00 = convolve(matrix, kernel, stride=(3, 1))
        answer_31_11_00 = np.array([[44., 58., 59., 62., 70., 80., 75., 92., 64., 72.],
                                    [75., 69., 64., 64., 69., 75., 70., 71., 75., 74.]])

        result_32_11_00 = convolve(matrix, kernel, stride=(3, 2))
        answer_32_11_00 = np.array([[44., 59., 70., 75., 64.],
                                    [75., 64., 69., 70., 75.]])

        result_46_11_00 = convolve(matrix, kernel, stride=(4, 6))
        answer_46_11_00 = np.array([[44., 75.],
                                    [74., 79.]])

        # only dilation: (1, 2), (1, 3), (2, 1), (2, 2), (2, 3)
        result_11_12_00 = convolve(matrix, kernel, dilation=(1, 2))
        ...
        result_11_13_00 = convolve(matrix, kernel, dilation=(1, 3))
        answer_11_13_00 = np.array([[48., 77.],
                                    [65., 65.],
                                    [73., 55.],
                                    [97., 67.],
                                    [84., 68.]])
        result_11_21_00 = convolve(matrix, kernel, dilation=(2, 1))
        answer_11_21_00 = np.array([[78., 73., 64., 72., 81., 69., 73., 69., 68., 81.]])

        result_11_22_00 = convolve(matrix, kernel, dilation=(2, 2))
        answer_11_22_00 = np.array([[67., 55., 80., 63., 77., 79.]])

        result_11_23_00 = convolve(matrix, kernel, dilation=(2, 3))
        answer_11_23_00 = np.array([[65., 79.]])

        # only paddings: (0, 1), (1, 0), (1, 1)
        result_11_11_01 = convolve(matrix, kernel, padding=(0, 1))
        ...
        result_11_11_10 = convolve(matrix, kernel, padding=(1, 0))
        ...
        result_11_11_11 = convolve(matrix, kernel, padding=(1, 1))
        ...
        result_21_13_00 = convolve(matrix, kernel, stride=(2, 1), dilation=(1, 3), padding=(0, 0))
        answer_21_13_00 = np.array([[48., 77.],
                                    [73., 55.],
                                    [84., 68.]])

        result_23_13_13 = convolve(matrix, kernel, stride=(2, 3), dilation=(1, 3), padding=(1, 3))
        answer_23_13_13 = np.array([[28., 36., 31.],
                                    [53., 65., 47.],
                                    [62., 97., 70.],
                                    [64., 79., 74.]])

        result_32_23_22 = convolve(matrix, kernel, stride=(3, 2), dilation=(2, 3), padding=(2, 2))
    ...
    def test_kernel_5x3_difficult(self):
        ...
        # default params
        result_11_11_00 = convolve(matrix, kernel, stride=(1, 1), dilation=(1, 1), padding=(0, 0))
        ...
        result_32_23_42 = convolve(matrix, kernel, stride=(3, 2), dilation=(2, 3), padding=(4, 2))
        answer_32_23_42 = np.array([[18., 10., 17.],
                                    [18., 17., 11.]])

        result_21_12_04 = convolve(matrix, kernel, stride=(2, 1), dilation=(1, 2), padding=(0, 4))
        answer_21_12_04 = np.array([[18., 34., 40., 44., 22., 37., 15., 19.,  0.,  7.,  0.]])

        result_22_12_04 = convolve(matrix, kernel, stride=(2, 2), dilation=(1, 2), padding=(0, 4))
        answer_22_12_04 = np.array([[18., 40., 22., 15.,  0.,  0.]])

        result_23_13_25 = convolve(matrix, kernel, stride=(2, 3), dilation=(1, 3), padding=(2, 5))
        answer_23_13_25 = np.array([[15., 27., 21.,  0.],
                                    [34., 27., 13.,  0.],
                                    [21., 11.,  3.,  0.]])

        result_11_11_33 = convolve(matrix, kernel, stride=(1, 1), dilation=(1, 1), padding=(3, 3))
